    ...
    <div class="pb-16">
      <div class="text-6xl text-white pt-12 pl-32">
          ...
          <div class="flex py-16">
            <button class="btn btn-lg rounded-full border-orange-500 bg-orange-500 hover:bg-orange-400"> <!-- Retained bg-orange-500 and text-2xl -->
                <span class="flex items-center text-white font-bold text-lg">Learn More</span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="white" class="h-6 w-6 ml-2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 6.75L22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3l-4.5 16.5" />
                </svg>
            </button>

            <button class="btn btn-lg rounded-full btn-blue ml-12 border-blue-500 bg-blue-500 hover:bg-blue-400"> <!-- Retained bg-blue-600 and text-2xl -->
                <span class="flex items-center text-white font-bold text-lg">Join Now</span>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 ml-2" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="white">
