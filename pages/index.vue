  ...
  <div class="p-4 max-sm:p-8 sm:p-8 xl:container xl:mx-auto">
    <div class="text-2xl md:text-4xl lg:text-6xl text-white">
      ...
      <div class="flex py-4 md:py-8 lg:py-16 gap-4 md:gap-8">
        <button class="btn btn-sm md:btn-lg rounded-full border-orange-500 bg-orange-500 hover:bg-orange-400">
        ...
        <button class="btn btn-sm md:btn-lg rounded-full btn-blue border-blue-500 bg-blue-500 hover:bg-blue-400">
          <span class="text-white font-bold text-cs md:text-lg">Join Now</span>
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 ml-2 ml-2 max-sm:h-4 max-sm:w-4 flex-shrink-0"
            fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="white">
            <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div
      ...
      <div class="flex items-center gap-[0.4rem] md:gap-4 sm:gap-4">
        <svg class="h-8 w-8 sm:h-16 sm:w-16 lg:h-28 lg:w-28 flex-shrink-0" fill="white"
      ...
      <div class="flex items-center mx-[-0.1rem] gap-[0.2rem] md:gap-4 sm:gap-4 ">
        <svg class="h-8 w-8 sm:h-16 sm:w-16 lg:h-28 lg:w-28 flex-shrink-0" xmlns="http://www.w3.org/2000/svg"
          fill="white" height="24" viewBox="0 -960 960 960" width="24">
          <path
    ...
    <div
      ...
      <h1 class="text-xl md:text-6xl text-orange-500 font-bold">
        Learn, Buidl, Repeat
      </h1>
      <p class="text-4xl text-white font-semibold max-sm:text-lg">
        We are democratizing blockchain and cryptocurrency knowledge through
